<?php
/**
 * Apply the minimal MassMailHtmlizer integration to EspoCRM 9.2.7.
 *
 * Usage:
 *   php patch-sending-processor-9.2.7.php /path/to/SendingProcessor.php
 */

declare(strict_types=1);

const ORIGINAL_SHA256 = 'ceedca1169c16e3828a94811cd7bb30d1fade23735096b411b74a41ed365688a';
...
if ($hash !== ORIGINAL_SHA256) {
    fwrite(
        STDERR,
        "FOUT: SendingProcessor.php is niet de verwachte schone EspoCRM 9.2.7-versie.\n" .
...
echo "SendingProcessor.php gepatcht voor MassMailHtmlizer op EspoCRM 9.2.7.\n";
